  ...
  return (
    <aside className="w-56 shrink-0 bg-lumiere-sidebar text-white min-h-screen flex flex-col p-4 border-r border-white/10">
      <div className="mb-8">
        ...
        <div className="text-xs text-white/55 mt-1 font-sans">Photographer dashboard</div>
      </div>

      <nav className="flex flex-col gap-1 flex-1">
        <NavLink to="/studio" end className={linkClass}>
          Clients
        </NavLink>
        <NavLink to="/studio/portfolios" className={linkClass}>
          Portfolios
        </NavLink>
        <NavLink to="/studio/history" className={linkClass}>
          History
        </NavLink>
        <NavLink to="/studio/my-portfolio" className={linkClass}>
          My portfolio
        </NavLink>
      </nav>
